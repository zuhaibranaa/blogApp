<div class="d-flex sidebar flex-column p-4" >
    <ul class="nav nav-pills flex-column mb-auto">
      <li>
        <a href="/dashboard" class="{{Request::is('dashboard') ? 'active' : ''}} nav-link link-light">
  ...
  <path fill-rule="evenodd" d="M0 10a8 8 0 1 1 15.547 2.661c-.442 1.253-1.845 1.602-2.932 1.25C11.309 13.488 9.475 13 8 13c-1.474 0-3.31.488-4.615.911-1.087.352-2.49.003-2.932-1.25A7.988 7.988 0 0 1 0 10zm8-7a7 7 0 0 0-6.603 9.329c.203.575.923.876 1.68.63C4.397 12.533 6.358 12 8 12s3.604.532 4.923.96c.757.245 1.477-.056 1.68-.631A7 7 0 0 0 8 3z"/>
      ...
      <li>
        <a href="/posts" class="{{Request::is('posts') ? 'active' : ''}} nav-link link-light">
    ...
    <path d="M3.5 2A1.5 1.5 0 0 0 2 3.5v11A1.5 1.5 0 0 0 3.5 16h6.086a1.5 1.5 0 0 0 1.06-.44l4.915-4.914A1.5 1.5 0 0 0 16 9.586V3.5A1.5 1.5 0 0 0 14.5 2h-11zM3 3.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 .5.5V9h-4.5A1.5 1.5 0 0 0 9 10.5V15H3.5a.5.5 0 0 1-.5-.5v-11zm7 11.293V10.5a.5.5 0 0 1 .5-.5h4.293L10 14.793z"/>
      ...
      <li>
        <a href="/comment" class="{{Request::is('comment') ? 'active' : ''}} nav-link link-light">
      ...
      <li>
        <a href="/profile" class="{{Request::is('profile') ? 'active' : ''}} nav-link link-light">
